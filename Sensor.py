...
insert_query = """
    INSERT INTO Readings (ENS160StatusFlag, AirQualityIndex, TVOC_ppb, ECO2_ppm, RelativeHumidity_Percent, Pressure_Pa, Altitude_Meters, Altitude_Feet, Temperature_C, Temperature_F)
